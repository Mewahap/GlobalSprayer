...
<head>
    ...
    <link rel="icon" type="image/png" href="assets/img/inventory.jpeg" />
...
<body id="page-top">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex text-white align-items-center bg-primary justify-content-center" href="<?= base_url('dashboard'); ?>">
                ...
                <div class="sidebar-brand-icon">
                    ...
                    <i aria-hidden="true"><img class="rounded" src="<?= base_url(); ?>assets/img/inventory.jpeg" width="50"></i>
                </div>
                <div class="sidebar-brand-text mx-3">GlobalSprayer</div>
            </a>
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
            ...
            <?php if (is_admin()) : ?>
                ...
                <!--<li class="nav-item">
                    <a class="nav-link pb-0" href="<?= base_url('penjualan'); ?>">
                        <i class="fas fa-fw fa-download"></i>
                        <span><b>Data Penjualan</b></span>
                    </a>
                </li>--> <!--INGAT INI TIDAK DIPAKAI MEWAHHHHH-->
    ...
    <script type="text/javascript">
        $(function() {
            ...
            let active = $('#accordionSidebar a').filter(function() {
                return this.href == link;
            }).parent().addClass('active').parent().parent().addClass('show').parent();
            if (active.is('li.nav-item')) {
    ...
    <?php if ($this->uri->segment(1) == 'dashboard') : ?>
        ...
        <script type="text/javascript">
            ...
            //Bar chart untuk barang terlaris
            var ctx = document.getElementById("myBarChart");
            var myBarChart = new Chart(ctx, {
                type: 'bar',
                data: {
                    labels: <?= json_encode($barang_terlaris); ?>,
                    datasets: [{
                        label: "Jumlah",
                        backgroundColor: "#4e73df",
                        hoverBackgroundColor: "#2e59d9",
                        borderColor: "#4e73df",
                        data: <?= json_encode($jumlah_terlaris); ?>,
                    }],
                },
                options: {
                    maintainAspectRatio: false,
