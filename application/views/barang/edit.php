        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('harga_masuk', $barang['harga_masuk']); ?>" name="harga_masuk" id="harga_masuk" type="number" class="form-control">
                        <?= form_error('harga_masuk', '<small class="text-danger">', '</small>'); ?>
                    </div>
                </div>

                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="harga_masuk">Harga Jual</label>
                    <div class="col-md-9">
