        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                    ...
                    <div class="col-md-5">
                        <select name="customer" id="customer" class="custom-select">
                            ...
                            <?php foreach ($customer as $b) : ?>
                                <option <?= $barangkeluar['customer'] == $b['id_customer'] ? 'selected' : '';  ?> value="<?= $b['id_customer'] ?>"><?= $b['nama'] ?></option>
                            <?php endforeach; ?>
                        </select>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-4">
                        <input value="<?= set_value('tanggal_keluar', $barangkeluar['tanggal_keluar']); ?>" name="tanggal_keluar" id="tanggal_keluar" type="date" class="form-control">
                        ...
                        <div class="input-group">
                            <select name="barang_id" id="barang_id" class="custom-select">
                                ...
                                <?php foreach ($barang as $b) : ?>
                                    <option <?= $barangkeluar['barang_id'] == $b['id_barang'] ? 'selected' : '';  ?> value="<?= $b['id_barang'] ?>"><?= $b['id_barang'] . ' | ' . $b['nama_barang'] ?></option>
                                <?php endforeach; ?>
                            </select>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-5">
                        <input readonly="readonly" id="stok" type="number" class="form-control" value="<?= $stok; ?>">
                    </div>
                </div>
                <div class="row form-group">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-5">
                        <input value="<?= set_value('total_stok', $stok - $barangkeluar['jumlah_keluar']); ?>" id="total_stok" type="number" class="form-control" readonly="readonly">
                    </div>
                </div>
                <!-- <div class="row form-group">
